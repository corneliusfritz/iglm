...
#' @description
#' The `netplus` class is a container for storing, validating, and analyzing
...
#' @export
netplus_generator <- R6::R6Class("netplus",
                                 private = list(
                                   .x_attribute = NULL,
                                   .y_attribute = NULL,
                                   .z_network = NULL,
                                 ...
                                 public = list(
                                   #' @description
                                   #' Create a new `netplus` object, that includes data on two attributes and one network. 
                                   #'
                                   ...
                                   #' @param file (character) Optional file path to load a saved `netplus` object state.  
                                   #' @return A new `netplus` object.
                                   initialize = function(x_attribute = NULL, y_attribute = NULL, z_network = NULL,
                                     ...
                                     if(!is.null(file)){
                                       ...
                                       if (!is.list(data_loaded) || !all(required_fields %in% names(data_loaded))) {
                                         stop("File does not contain a valid netplus state.", call. = FALSE)
                                       }
                                   ...
                                   #' @description
                                   #' Gathers the current state of the `netplus` object into a list.
                                   #' This includes all attributes, network, and configuration
                                   #' details necessary to reconstruct the object later.
                                   #' @return A list containing the current state of the `netplus` object.
                                   gather = function(){
                                     data_to_save <- list(
                                   ...
                                   #' @description
                                   #' Saves the current state of the `netplus` object to a specified file path
                                   ...
                                   #' @return The `netplus` object itself (`self`), invisibly. 
                                   save = function(file){
                                   ...
                                   #' @description
                                   #' Print a summary of the `netplus` object to the console.
                                   #'
...
#' This function acts as a user-friendly interface to the `netplus` R6 class generator.
...
#'   generated implying global dependence. If `FALSE`, no neighborhood is set.
#' @param file (character) Optional file path to load a saved `netplus` object state.   
#' @return An object of class `netplus` (and `R6`).
#' @export
netplus <- function(x_attribute = NULL, y_attribute = NULL, z_network = NULL,
                    neighborhood = NULL, directed = NA, n_actor = NA, 
                    type_x = "binomial", type_y = "binomial",
                    scale_x = 1, scale_y = 1, 
                    return_neighborhood = TRUE, file = NULL) {
  netplus_generator$new(x_attribute = x_attribute,
