<!-- badges: start -->
  [![Codecov test coverage](https://codecov.io/gh/corneliusfritz/xyzmodeling_project/graph/badge.svg)](https://app.codecov.io/gh/corneliusfritz/xyzmodeling_project)
<!-- badges: end -->
