...
family_x <- "binomial"
family_y <- "binomial"
object = iglm.data(neighborhood = neighborhood, directed = F, family_x = family_x, family_y = family_y, n_units = n_units)
```
...
gt_coef_degrees =  c(rnorm(n = n_units, -2, 1))
# Define the sampler
