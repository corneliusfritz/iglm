...
- [`sampler.iglm.generator`](sampler.iglm.generator.md)
  [`sampler.iglm`](sampler.iglm.generator.md) : R6 Class for iglm
  Sampler Settings
...
- [`simulate(`*`<iglm>`*`)`](simulate.iglm.md) : Simulate responses and
  connections
