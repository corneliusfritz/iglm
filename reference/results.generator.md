...
- [`results$new()`](#method-results-initialize)

- [`results$set_model_assessment()`](#method-results-set_model_assessment)

- [`results$set_prediction()`](#method-results-set_prediction)

- [`results$gather()`](#method-results-gather)

- [`results$save()`](#method-results-save)

- [`results$resize()`](#method-results-resize)

- [`results$update()`](#method-results-update)

- [`results$remove_samples()`](#method-results-remove_samples)

- [`results$plot()`](#method-results-plot)
...
#### Usage
    ...
    results$new(size_coef, size_coef_degrees, file)
...
#### Usage
    ...
    results$set_model_assessment(res)
...
### `results$set_prediction()`

Stores prediction results.

#### Usage

    results$set_prediction(prediction)
...
#### Usage
    ...
    results$resize(size_coef, size_coef_degrees)
...
#### Usage
    ...
    results$plot(trace = FALSE, stats = FALSE, model_assessment = FALSE, ...)
